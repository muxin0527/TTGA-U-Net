...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    if task == 'Task001_ACDC':
        ...
        pickle.dump(plans, pickle_file)
        pickle_file.close()
    elif task == 'Task901_LiverVessel' or task == 'Task902_LiverVessel' or task == 'Task903_LiverVessel' or task == 'Task904_LiverVessel' or task == 'Task905_LiverVessel' or task=='Task921_MRLiverVessel' or task=='Task922_MRLiverVessel' or task=='Task923_MRLiverVessel' or task=='Task924_MRLiverVessel' or task=='Task925_MRLiverVessel':
        plans['plans_per_stage'][Stage]['batch_size'] = 4
        plans['plans_per_stage'][Stage]['patch_size'] = np.array([16, 160, 160])
        pickle_file = open(plans_file, 'wb')
        pickle.dump(plans, pickle_file)
