...
from unetr_pp.training.network_training.network_trainer_ctlivervessel import NetworkTrainer_ctlivervessel
...
class Trainer_ctlivervessel(NetworkTrainer_ctlivervessel):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Trainer_ctlivervessel, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(Trainer_ctlivervessel, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(Trainer_ctlivervessel, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
