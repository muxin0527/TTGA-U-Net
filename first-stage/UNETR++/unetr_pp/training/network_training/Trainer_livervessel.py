...
from unetr_pp.training.network_training.network_trainer_livervessel import NetworkTrainer_livervessel
...
class Trainer_livervessel(NetworkTrainer_livervessel):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Trainer_livervessel, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(Trainer_livervessel, self).run_training()
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(Trainer_livervessel, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
