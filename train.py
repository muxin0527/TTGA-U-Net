...
import sys
from model.TGA_UNet import GraphAttention
...
def main(args):
    ...
    train_dataset = MRDataset(mode='train', thickness=args.contour, path=args.graph_save_path)
    valid_dataset = MRDataset(mode='valid', thickness=args.contour, path=args.graph_save_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gat_Result_path', type=str, default='../graph-construction',
                        help="OCTA Result_path ")
    parser.add_argument("--graph_save_path", type=str, default='../graph-construction/Graph',
    ...
    parser.add_argument("--gat_lr", type=float, default=0.01,
                        help="learning rate")
